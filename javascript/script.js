...
function updateTimer() {
  const targetDate = new Date("june 6, 2026 20:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '542634635766'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '542634635766'; // Número para el primer botón
  const recipientNumber2 = '542634255078'; // Número para el segundo botón
