const CACHE_NAME = 'cache-v61'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v61',
    'estilos/styles.css?v61',
    'estilos/mediaQueries.css?v61',
    'javascript/script.js?v61',
